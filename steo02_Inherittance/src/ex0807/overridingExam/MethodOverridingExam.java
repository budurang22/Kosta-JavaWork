...
class SubClass extends SuperClass{
	...
	public void methodZero(){	// 부모의 접근제한자보다 작아서 오버라이딩 안됨
		System.out.println("SubClass객체의 methodZero()메소드가 호출되었습니다.");
		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString);
	}
 	
	public void methodOwn(){  // 부모의 접근제한자보다 작다, 리턴타입이 없어야함
		System.out.println("SubClass객체의 methodOwn()메소드가 호출되었습니다.");
 		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString);
 		// return intNumber;
 	}
 	
	protected int methodTwo(int a){ // 부모의 접근제한자보다 작다, 리턴타입이 int로 같아야한다
 		intNumber=a;
	...
	public String methodThree( int k,String str){   // 부모 접근제한자보다 작다
 		intNumber=k;
 		memberString=str;
 		System.out.println("SubClass객체의 methodThree()메소드가 호출되었습니다.");
 		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString);
	...
	public void methodFour(){   // 부모의 리턴타입과 달라서
