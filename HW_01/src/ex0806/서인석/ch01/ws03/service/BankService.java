package ex0806.서인석.ch01.ws03.service;

import ex0806.서인석.ch01.ws03.dto.AccountDto;
import ex0806.서인석.ch01.ws03.dto.UserDto;
...
public class BankService {
	...
	*/
	public AccountDto[] getAccountList(int userSeq) {
        int count = 0; // 인수로 전달된 userSeq와 동일한 계좌 개수 찾기
        ...
        if (count == 0) return null; // 위에 for문에서 같은걸 찾는데 0개라면 null 리턴

        // 찾은 계좌의 개수를 배열에 넣어 리턴
