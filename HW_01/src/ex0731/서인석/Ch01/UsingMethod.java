...
class UsingMethodExam{
	...
	*/
    public String methodExam03_02(String str, int i) {
        ...
        int result = this.methodExam03_01(i);
        System.out.println("methodExam03_01 : " + result);
        System.out.println("인수 : " + i);
	...
	*/
    protected double methodExam03_04(int i, double d, int j) {
        ...
        MakeMethodExam02 methodCall = new MakeMethodExam02();

        double result = methodCall.methodExam02_04(i, d, j);
...
class UsingMethod{
    ...
    public static void main(String[] args) {
        UsingMethodExam methodCall = new UsingMethodExam();
        System.out.println("==============main method start=============");

        // methodExam03_02 출력
        String method02 = methodCall.methodExam03_02("멍청이", 100);
        System.out.println("\nmethod02 : " + method02);

        // methodExam03_03 출력
        methodCall.methodExam03_03(1000, "어렵다...");

        // methodExam03_04 출력
        methodCall.methodExam03_04(10, 5.5, 2);
